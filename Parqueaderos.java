...
public class Parqueaderos {
    public static void main(String[] args) throws InterruptedException {
        ParqueaderoController parqueaderos = new ParqueaderoController(5);

        // Registrar entrada
        entrada entrada = parqueaderos.registrarEntrada("ABC123", "Carro");
        if (entrada != null) {
        ...
        // Registrar salida
        salida salida = parqueaderos.registrarSalida("ABC123");
        if (salida != null) {
